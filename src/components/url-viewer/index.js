...
module.exports = Vue.component('url-viewer', {
  ...
  watch: {
    currentDevice: function(val) {
      this.$parent.$emit('url-viewer:device-did-change', this.currentDevice);
    },
    currentDirection: function(val) {
      this.$parent.$emit('url-viewer:direction-did-change', this.currentDirection);
